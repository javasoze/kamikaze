...
public class PForDeltaUnpack128{
  ...
  for(i=0, w=1; i<4; ++i, w+=28){
    out[0+(i<<5)] = ((in[w+0]) & 268435455);
    out[1+(i<<5)] = ((in[w+0] >>> 28) & 268435455);
    out[1+(i<<5)] |= ((in[w+1] << 4) & 268435455);
    out[2+(i<<5)] = ((in[w+1] >>> 24) & 268435455);
    out[2+(i<<5)] |= ((in[w+2] << 8) & 268435455);
    out[3+(i<<5)] = ((in[w+2] >>> 20) & 268435455);
    out[3+(i<<5)] |= ((in[w+3] << 12) & 268435455);
    out[4+(i<<5)] = ((in[w+3] >>> 16) & 268435455);
    out[4+(i<<5)] |= ((in[w+4] << 16) & 268435455);
    out[5+(i<<5)] = ((in[w+4] >>> 12) & 268435455);
    out[5+(i<<5)] |= ((in[w+5] << 20) & 268435455);
    out[6+(i<<5)] = ((in[w+5] >>> 8) & 268435455);
    out[6+(i<<5)] |= ((in[w+6] << 24) & 268435455);
    out[7+(i<<5)] = ((in[w+6] >>> 4) & 268435455);
    out[8+(i<<5)] = ((in[w+7]) & 268435455);
    out[9+(i<<5)] = ((in[w+7] >>> 28) & 268435455);
    out[9+(i<<5)] |= ((in[w+8] << 4) & 268435455);
    out[10+(i<<5)] = ((in[w+8] >>> 24) & 268435455);
    out[10+(i<<5)] |= ((in[w+9] << 8) & 268435455);
    out[11+(i<<5)] = ((in[w+9] >>> 20) & 268435455);
    out[11+(i<<5)] |= ((in[w+10] << 12) & 268435455);
    out[12+(i<<5)] = ((in[w+10] >>> 16) & 268435455);
    out[12+(i<<5)] |= ((in[w+11] << 16) & 268435455);
    out[13+(i<<5)] = ((in[w+11] >>> 12) & 268435455);
    out[13+(i<<5)] |= ((in[w+12] << 20) & 268435455);
    out[14+(i<<5)] = ((in[w+12] >>> 8) & 268435455);
    out[14+(i<<5)] |= ((in[w+13] << 24) & 268435455);
    out[15+(i<<5)] = ((in[w+13] >>> 4) & 268435455);
    out[16+(i<<5)] = ((in[w+14]) & 268435455);
    out[17+(i<<5)] = ((in[w+14] >>> 28) & 268435455);
    out[17+(i<<5)] |= ((in[w+15] << 4) & 268435455);
    out[18+(i<<5)] = ((in[w+15] >>> 24) & 268435455);
    out[18+(i<<5)] |= ((in[w+16] << 8) & 268435455);
    out[19+(i<<5)] = ((in[w+16] >>> 20) & 268435455);
    out[19+(i<<5)] |= ((in[w+17] << 12) & 268435455);
    out[20+(i<<5)] = ((in[w+17] >>> 16) & 268435455);
    out[20+(i<<5)] |= ((in[w+18] << 16) & 268435455);
    out[21+(i<<5)] = ((in[w+18] >>> 12) & 268435455);
    out[21+(i<<5)] |= ((in[w+19] << 20) & 268435455);
    out[22+(i<<5)] = ((in[w+19] >>> 8) & 268435455);
    out[22+(i<<5)] |= ((in[w+20] << 24) & 268435455);
    out[23+(i<<5)] = ((in[w+20] >>> 4) & 268435455);
    out[24+(i<<5)] = ((in[w+21]) & 268435455);
    out[25+(i<<5)] = ((in[w+21] >>> 28) & 268435455);
    out[25+(i<<5)] |= ((in[w+22] << 4) & 268435455);
    out[26+(i<<5)] = ((in[w+22] >>> 24) & 268435455);
    out[26+(i<<5)] |= ((in[w+23] << 8) & 268435455);
    out[27+(i<<5)] = ((in[w+23] >>> 20) & 268435455);
    out[27+(i<<5)] |= ((in[w+24] << 12) & 268435455);
    out[28+(i<<5)] = ((in[w+24] >>> 16) & 268435455);
    out[28+(i<<5)] |= ((in[w+25] << 16) & 268435455);
    out[29+(i<<5)] = ((in[w+25] >>> 12) & 268435455);
    out[29+(i<<5)] |= ((in[w+26] << 20) & 268435455);
    out[30+(i<<5)] = ((in[w+26] >>> 8) & 268435455);
    out[30+(i<<5)] |= ((in[w+27] << 24) & 268435455);
    out[31+(i<<5)] = ((in[w+27] >>> 4) & 268435455);
  }
  }
}
